...
`2018-11-05 10:03:40.216  INFO 39766 --- [ fooGroup-0-C-1] org.apache.flink.statefun.playground.java.greeter.example.Application                  : Received: Foo2 [foo=bar]`
...
`2018-11-05 10:12:32.552  INFO 41635 --- [ fooGroup-0-C-1] org.apache.flink.statefun.playground.java.greeter.example.Application                  : Received: Foo2 [foo=fail]`
...
`...`
`2018-11-05 10:12:33.033  INFO 41635 --- [ fooGroup-0-C-1] org.apache.flink.statefun.playground.java.greeter.example.Application                  : Received: Foo2 [foo=fail]`
...
`...`
`2018-11-05 10:12:33.537  INFO 41635 --- [ fooGroup-0-C-1] org.apache.flink.statefun.playground.java.greeter.example.Application                  : Received: Foo2 [foo=fail]`
`2018-11-05 10:12:43.359  INFO 41635 --- [ dltGroup-0-C-1] org.apache.flink.statefun.playground.java.greeter.example.Application                  : Received from DLT: {"foo":"fail"}`
